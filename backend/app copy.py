...
db = SQLAlchemy()   # ← 1) YA NO inicializamos aquí

app = Flask(__name__)

# Habilitmos CORS para local
#CORS(app)
CORS(
    app,
...
# ==========================================================
# PRE
#DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@postgres:5432/imv")
# LOCAL
...
print(">>> DATABASE_URL USADA POR EL BACKEND:", DATABASE_URL)
...
#     query = Patient.query.order_by(Patient.id).limit(limit).offset(offset)
...
# ==========================================================
# ENDPOINT PARA LANZAR SIMULACIONES (K8S JOBS)
# ==========================================================
...
# ==========================================================
# ESTADO DE SIMULACIONES (JOBS + LOGS + HISTORIAL)
# ==========================================================
