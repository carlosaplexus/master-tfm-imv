...
La arquitectura se ha diseñado para ejecutarse en AWS EKS (AWS Academy).
...
Acceder al frontend
   Abre en el navegador: http://<LOADBALANCER_URL>

5. Lanzar simulaciones desde el frontend
   En la sección Simulaciones:
      Eligir número de generadores
      Eligir pacientes por generador
